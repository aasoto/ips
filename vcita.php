...
<div class="row">
  <div class="col-md-10">
    <h1>Nueva Cita</h1>
    <form class="form-horizontal" method="post" id="addproduct" action="ccita.php" role="form">
        ...
        <div class="col-lg-10">
          ...
          <option value="">-- SELECCIONE --</option>
            <?php for($i=0;$i<count($inf_pacientes);$i++){?>
              <option value="<?php echo $inf_pacientes[$i]["numdoc"]; ?>"><?php echo $inf_pacientes[$i]["numdoc"]." - ".$inf_pacientes[$i]["nom1"]." ".$inf_pacientes[$i]["nom2"]." ".$inf_pacientes[$i]["apellido1"]." ".$inf_pacientes[$i]["apellido2"]; ?></option>
            <?php } ?>
          </select>
        </div>
      </div>
